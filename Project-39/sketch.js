...
function setup() {
  ...
  //Setting the scale of gameOver and restart.
  gameOver.scale = 0.5;
  restart.scale = 0.1;
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    //Resetting the background to look like it is infinitely scrolling.
    if(jungle.x<100)
    {
       jungle.x=400
    }

    //Making the kangaroo jump when space is pressed.
